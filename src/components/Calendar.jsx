...
function CalanderView() {
    return (
        <div className="lg:flex lg:h-full lg:flex-col min-h-screen">
            <header className="flex items-center justify-between border-b border-gray-200 px-6 py-4 lg:flex-none">
                ...
                <div className="flex items-center">
                    ...
                    <div className="hidden md:ml-4 md:flex md:items-center">
                        ...
                        <button
                            type="button"
                            className="ml-6 rounded-md  bg-green-400 px-3 py-2 text-sm font-semibold text-black shadow-sm hover:bg-green-300 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-green-600"
                        >
                            Add event
                        </button>
                    </div>
            ...
            <div className="py-5 lg:pl-72">
                <div className="px-4 sm:px-6 lg:px-8">
                    ...
                    <p className="mt-2 text-sm text-gray-500">
                        Welcome to the Calendar. Here you can manage your important events
                    </p>
                    {CalanderView()}
                </div>
            </div>
